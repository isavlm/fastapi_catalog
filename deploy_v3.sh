...
pip3 install fastapi uvicorn sqlalchemy psycopg2-binary python-dotenv pydantic
...
ExecStart=/home/ec2-user/.local/bin/uvicorn application:application --host 0.0.0.0 --port 8000 --log-level info
